...
from .sampler import SportsMOTSampler
from .dukemtmcreid import DukeMTMCreID
from .market1501 import Market1501
from .msmt17 import MSMT17
from .dataset_sportsmot import SportsMOTFootball
...
__factory = {
    ...
    'veri': VeRi,
    'VehicleID': VehicleID,
    'sportsmot_football': SportsMOTFootball
}
...
def make_dataloader(cfg):
    train_transforms = T.Compose([
            ...
            # Add photometric augmentations for more variability and to help generalization
            T.ColorJitter(hue=0.05,saturation=0.2, brightness=0.2),
            T.RandomApply([T.Lambda(
                lambda img: F.adjust_gamma(img, gamma=random.uniform(0.8, 1.2))
            )], p=0.3),
            T.RandomApply([T.GaussianBlur(kernel_size=(3,5))], p=0.1),
            T.ToTensor(),
    ...
    if 'triplet' in cfg.DATALOADER.SAMPLER:
        if cfg.MODEL.DIST_TRAIN:
            ...
            # Entering this since I'm currently not using dist train
            train_loader_stage2 = DataLoader(
                ...
                sampler=SportsMOTSampler(dataset.train, cfg.SOLVER.STAGE2.IMS_PER_BATCH, cfg.DATALOADER.NUM_INSTANCE),
